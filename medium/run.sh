...
python main.py --backbone gcn --dataset film --lr 0.1 --num_layers 2 \
    ...
    --method ours --ours_layers 1 --use_graph --graph_weight 0.5 --num_heads 1 --ours_use_residual --ours_use_act \
    --alpha 0.5 --ours_dropout 0.6 --ours_weight_decay 0.0005 --device 2 --runs 10 --epochs 200
...
python main.py --backbone gcn  --dataset squirrel --lr 0.001 --num_layers 5 \
    --hidden_channels 64 --weight_decay 5e-4 --dropout 0.3   \
    --method ours --ours_layers 1 --use_graph --ours_use_act --ours_use_residual --num_heads 1 \
    --alpha 0.5  --device 1 --runs 10
